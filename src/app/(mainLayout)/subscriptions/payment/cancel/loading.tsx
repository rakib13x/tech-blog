...
export const metadata: Metadata = {
  ...
  description:
    "Your payment process was cancelled. Return to checkout or explore other options on Tech Tunes.",
  keywords:
    "Payment Cancelled, Tech Tunes, transaction cancelled, checkout, payment error",
};
